...
var category = {OBJ: $("#_JD_ALLSORT"),
		// URL_Serv: "http://manage.happygo.com/web/itemcat/all?callback=category.getDataService",
		// URL_Serv: "/js/item-cat-all.json",
		URL_Serv: "http://manage.happygo.com/rest/api/item/cat?callback=category.getDataService",
		// URL_Serv: "http://manage.happygo.com/rest/api/item/cat",
        ...
        return "" == c ? d : (/^http[s]?:\/\/([\w-]+\.)+[\w-]+([\w-.\/?%&=]*)?$/.test(c) || (c = c.replace(/-000$/, ""), c = c.match(/^\d*-\d*$/) ? "http://channel.jd.com/" + c + ".html" : "http://www.happygo.com" + c + ".html"), '<a href="' + c + '">' + d + "</a>")
