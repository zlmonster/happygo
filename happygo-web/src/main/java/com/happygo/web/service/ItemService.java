...
//
//    @Value("${HAPPYGO_MANAGE_URL}")
//    private String HAPPYGO_MANAGE_URL;
//
...
//
//    public static final String REDIS_KEY = "HAPPYGO_WEB_ITEM_DETAIL_";
//
...
//        }
//
//        String url = HAPPYGO_MANAGE_URL + "/rest/api/item/" + itemId;
//        try {
...
//        String url = HAPPYGO_MANAGE_URL + "/rest/api/item/desc/" + itemId;
//        try {
//            String jsonData = this.apiService.doGet(url);
//            if (StringUtils.isEmpty(jsonData)) {
//                return null;
...
//        String url = HAPPYGO_MANAGE_URL + "/rest/api/item/param/item/" + itemId;
//        try {
//            String jsonData = this.apiService.doGet(url);
//            if (StringUtils.isEmpty(jsonData)) {
//                return null;
