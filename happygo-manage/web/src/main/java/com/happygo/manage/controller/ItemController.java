...
import com.happygo.manage.service.ItemService;
...
//     */
//    @RequestMapping(method = RequestMethod.PUT)
//    public ResponseEntity<Void> updateItem(@RequestParam("ids") String ids) {
//        try {
//
//            // 编辑商品
//            Boolean bool = this.itemService.deleteByIds(item, desc, itemParams);
//            if (!bool) {
//                if (LOGGER.isInfoEnabled()) {
//                    LOGGER.info("编辑商品失败， item = {}", item);
//                }
